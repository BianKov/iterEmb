...
for s, t in G_original.edges():
    G_reweighted.add_edge(s, t, weight=1.0 / (0.001 + G_current[s][t]["weight"]))
...
np.savetxt(
    os.getcwd() + "/" + directoryName + "/LE_angSeparation.txt", separationMeasureList
)
np.savetxt(os.getcwd() + "/" + directoryName + "/LE_angSepNumerator.txt", numeratorList)
np.savetxt(
    os.getcwd() + "/" + directoryName + "/LE_angSepDenominator.txt", denominatorList
)
...
ReportFileHandler = open(os.getcwd() + "/" + directoryName + "/LE_Louvain.txt", "w")
# properties of the examined network
ReportFileHandler.write("numOfNodes = " + str(numOfNodes) + "\n")
ReportFileHandler.write("numOfEdges = " + str(numOfEdges) + "\n")
ReportFileHandler.write("numOfComms_real = " + str(numOfComms_real) + "\n")
...
ReportFileHandler = open(os.getcwd() + "/" + directoryName + "/LE_kMeans.txt", "w")
# properties of the examined network
ReportFileHandler.write("numOfNodes = " + str(numOfNodes) + "\n")
ReportFileHandler.write("numOfEdges = " + str(numOfEdges) + "\n")
ReportFileHandler.write("numOfComms_real = " + str(numOfComms_real) + "\n")
