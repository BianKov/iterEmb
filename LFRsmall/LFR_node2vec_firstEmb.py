...
for mu in muList:
    ...
    ReportFileHandler = open(os.getcwd() + "/" + directoryName + "/node2vecResults_readable_firstEmb.txt", 'w')
    ...
    ReportFileHandler = open(os.getcwd() + "/" + directoryName + "/node2vecResults_firstEmb.txt", 'w')
